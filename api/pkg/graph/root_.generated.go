...
import (
	...
	"github.com/tuoitrevohoc/app-template/api/pkg/graph/models"
...
"""
interface Node @goModel(model: "github.com/tuoitrevohoc/app-template/api/pkg/ent.Noder") {
...
enum RoleName @goModel(model: "github.com/tuoitrevohoc/app-template/api/pkg/ent/role.Name") {
  User
  Administrator
}

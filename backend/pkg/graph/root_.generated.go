...
import (
	...
	"github.com/tuoitrevohoc/app-template/backend/pkg/graph/models"
...
type ComplexityRoot struct {
	...
	Migration struct {
		ExecutionAt func(childComplexity int) int
		ID          func(childComplexity int) int
		Migration   func(childComplexity int) int
	}

	Mutation struct {
		CreateInvoice func(childComplexity int, input ent.CreateInvoiceInput) int
	...
	Query struct {
		...
		Permissions func(childComplexity int, after *ent.Cursor, first *int, before *ent.Cursor, last *int) int
		Roles       func(childComplexity int, after *ent.Cursor, first *int, before *ent.Cursor, last *int) int
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Migration.executionAt":
		if e.complexity.Migration.ExecutionAt == nil {
			break
		}

		return e.complexity.Migration.ExecutionAt(childComplexity), true
	...
	case "Migration.migration":
		if e.complexity.Migration.Migration == nil {
			break
		}

		return e.complexity.Migration.Migration(childComplexity), true
	...
	case "Mutation.createInvoice":
		...
		return e.complexity.Mutation.CreateInvoice(childComplexity, args["input"].(ent.CreateInvoiceInput)), true
	...
	case "Query.permissions":
		...
		return e.complexity.Query.Permissions(childComplexity, args["after"].(*ent.Cursor), args["first"].(*int), args["before"].(*ent.Cursor), args["last"].(*int)), true
	...
	case "Query.roles":
		...
		return e.complexity.Query.Roles(childComplexity, args["after"].(*ent.Cursor), args["first"].(*int), args["before"].(*ent.Cursor), args["last"].(*int)), true
...
var sources = []*ast.Source{
	{Name: "../../schema/graphql/ent.graphql", Input: `directive @goField(forceResolver: Boolean, name: String) on FIELD_DEFINITION | INPUT_FIELD_DEFINITION
...
"""
interface Node @goModel(model: "github.com/tuoitrevohoc/app-template/backend/pkg/ent.Noder") {
...
enum RoleName @goModel(model: "github.com/tuoitrevohoc/app-template/backend/pkg/ent/role.Name") {
  User
  Administrator
}
...
`, BuiltIn: false},
	{Name: "../../schema/graphql/invoice.graphql", Input: `extend type Mutation {
  createInvoice(input: CreateInvoiceInput!): Invoice
  deleteInvoice(id: ID!): Invoice
}
`, BuiltIn: false},
	{Name: "../../schema/graphql/user.graphql", Input: `input RegisterInput {
  username: String!
  password: String!
}

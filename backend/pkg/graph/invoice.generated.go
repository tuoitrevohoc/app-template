...
type MutationResolver interface {
	CreateInvoice(ctx context.Context, input ent.CreateInvoiceInput) (*ent.Invoice, error)
	DeleteInvoice(ctx context.Context, id int) (*ent.Invoice, error)
	Login(ctx context.Context, username string, password string) (*ent.User, error)
	Register(ctx context.Context, input models.RegisterInput) (*ent.User, error)
}
...
func (ec *executionContext) field_Mutation_createInvoice_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	var arg0 ent.CreateInvoiceInput
	if tmp, ok := rawArgs["input"]; ok {
		ctx := graphql.WithPathContext(ctx, graphql.NewPathWithField("input"))
		arg0, err = ec.unmarshalNCreateInvoiceInput2githubᚗcomᚋtuoitrevohocᚋappᚑtemplateᚋapiᚋpkgᚋentᚐCreateInvoiceInput(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) field_Mutation_register_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["input"]; ok {
		ctx := graphql.WithPathContext(ctx, graphql.NewPathWithField("input"))
		arg0, err = ec.unmarshalNRegisterInput2githubᚗcomᚋtuoitrevohocᚋappᚑtemplateᚋapiᚋpkgᚋgraphᚋmodelsᚐRegisterInput(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) _Mutation_createInvoice(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		...
		return ec.resolvers.Mutation().CreateInvoice(rctx, fc.Args["input"].(ent.CreateInvoiceInput))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null

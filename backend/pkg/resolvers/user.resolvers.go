...
import (
	...
	models1 "github.com/tuoitrevohoc/app-template/backend/pkg/graph/models"
...
func (r *mutationResolver) Register(ctx context.Context, input models1.RegisterInput) (*ent.User, error) {
